...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	int coins , player , buyAmount , totalStar , gameNo, plane; 
	public GameObject Dialog , UnLockDialog , homeScreen , LevelScreen , CarScreen;

    //------------------------------------------------------------------------
    void Start() 
    {
//    	PlayerPrefs.DeleteAll();
//		PlayerPrefs.SetInt("BestStar1",4);
		coins = PlayerPrefs.GetInt("Coin");
		player = PlayerPrefs.GetInt("GameNo");
		plane = PlayerPrefs.GetInt ("Plane");
		PlayerPrefs.SetString("Game1","yes");
//		GameNo
		firstPage  = plane;
		startingPage = player;
		_currentPage = player;
...
//		SetStar();
    ...
    private void SetPagePositions() 
    {
        ...
        Vector2 newPosition = new Vector2(containerWidth , containerHeight );
        ...
        for (int i = 0; i < _pageCount; i++) 
        {
            ...
            if (_horizontal) 
                childPosition = new Vector2(i * width - containerWidth  + offsetX, 0f);
            else 
                childPosition = new Vector2(0f, -(i * height - containerHeight  + offsetY ));
...
//		for(int i = 1 ; i <= 10 ; i++)
//		{
//			totalStar += PlayerPrefs.GetInt("BestStar"+i);
//			for(int j = 0 ; j < PlayerPrefs.GetInt("BestStar"+i) ; j++)
//				GameObject.Find("Game"+i+"/star").transform.GetChild(j).GetComponent<Image>().enabled = true;
//		}
//		GameObject.Find("Panel/star/Text").GetComponent<Text>().text = ""+totalStar;
//
//		for(int k = 1 ; k <= 10 ; k ++)
//		{
//			if((k -1) * 3 <= totalStar)
//				PlayerPrefs.SetString("Game"+k,"yes");
//		}
//    }
...
//		for(int i = 1 ; i <= 10 ; i++)
//		{
//			if(PlayerPrefs.GetString("Game"+i) != "yes")
//				GameObject.Find("GameSelect/Panel/List/Container/Game"+i+"/Lock").GetComponent<Image>().enabled = true;
//			else
//				GameObject.Find("GameSelect/Panel/List/Container/Game"+i+"/Lock").SetActive(false);
//		}
//		if(PlayerPrefs.GetString("Game"+_currentPage) != "yes")
//			GameObject.Find("Car/BuyText").GetComponent<Text>().text = ""+((_currentPage + 1) * 1000)+" $ BUY";
//		else
//			GameObject.Find("Car/BuyText").GetComponent<Text>().text = "";

//		GameObject.Find("TotalCoin").GetComponent<Text>().text = ""+coins;
//		SliderValueChange();

//	}

//
//	public void GoCarButton()
//	{	
//		gameNo = _currentPage+1;
//		print(PlayerPrefs.GetString("Game"+gameNo));
////		if(PlayerPrefs.GetString("Game"+gameNo) == "yes")
////		{
//			PlayerPrefs.SetInt("GameNo",_currentPage);
////			SceneManager.LoadScene(_currentPage + 1);
//
...
//		coins -= (_currentPage + 1) * 1000;
//		PlayerPrefs.SetInt("Coin",coins);
//		PlayerPrefs.SetString("Car"+_currentPage, "yes");
//		CheckForAvailability();
//	}
